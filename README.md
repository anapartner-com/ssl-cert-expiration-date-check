...
- For Java (Linux/Win):  Use the java keytool binary  (The below example demonstrates adding a custom ADS root ca cert to the local Java keystore with the default password of "changeit" )  
